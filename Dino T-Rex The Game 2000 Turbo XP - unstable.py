...
def jeu(difficulte,pos_caillou_x,pos_caillou_y,pos_caillou_x2,pos_caillou_y2,pos_boost_x,pos_boost_y,score,num_score,line,line2):
    global boucle
    global collide
    ##programme principal
    continuer = 1
...
boucle = 1
while boucle == 1:
    jeu(difficulte,pos_caillou_x,pos_caillou_y,pos_caillou_x2,pos_caillou_y2,pos_boost_x,pos_boost_y,score,num_score,line,line2)
